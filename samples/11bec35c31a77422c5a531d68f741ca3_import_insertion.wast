(module
  ...
  (import "env" "_addBusinessEvent" (func $wade._addBusinessEvent (type $t4)))
  (import "env" "_Mix_ChannelFinished" (func $wade._Mix_ChannelFinished (type $t1)))
  (import "env" "_glRotatef" (func $wade._glRotatef (type $t8)))
  (import "env" "_emscripten_glGetQueryObjecti64vEXT" (func $wade._emscripten_glGetQueryObjecti64vEXT (type $t3)))
  (import "env" "_alcMakeContextCurrent" (func $wade._alcMakeContextCurrent (type $t3)))
  (import "env" "invoke_iiiiiii" (func $wade.invoke_iiiiiii (type $t4)))
  (import "env" "na" (func $wade.na (type $t10)))
  (import "env" "invoke_viiiijii" (func $wade.invoke_viiiijii (type $t4)))
  (import "env" "STACKTOP" (global $env.STACKTOP i32))
  (import "env" "_emscripten_glScissor" (func $wade._emscripten_glScissor (type $t8)))
  (import "env" "_15cc8d14" (func $wade._15cc8d14 (type $t8)))
  (import "env" "_emscripten_glCopyTexSubImage3D" (func $wade._emscripten_glCopyTexSubImage3D (type $t7)))
  (import "env" "invoke_iifii" (func $wade.invoke_iifii (type $t7)))
  (import "env" "STACK_MAX" (global $env.STACK_MAX i32))
  (import "env" "invoke_viiiff" (func $wade.invoke_viiiff (type $t7)))
  (import "env" "_sigdelset" (func $wade._sigdelset (type $t4)))
  (import "env" "emscripten_glGetShaderiv" (func $wade.emscripten_glGetShaderiv (type $t3)))
  (import "env" "_llvm_trap" (func $wade._llvm_trap (type $t2)))
  (import "env" "emscripten_glGetString" (func $wade.emscripten_glGetString (type $t3)))
  (import "env" "abort" (func $env.abort (type $t1)))
  (import "env" "ab" (func $wade.ab (type $t1)))
  (import "env" "_JS_UNETWebSockets_SocketRecvEvntTypeFromHost" (func $wade._JS_UNETWebSockets_SocketRecvEvntTypeFromHost (type $t9)))
  (import "env" "Ob" (func $wade.Ob (type $t6)))
  (import "env" "gb" (func $wade.gb (type $t7)))
  (import "env" "_sigprocmask" (func $wade._sigprocmask (type $t2)))
  (import "env" "emscripten_glCompileShader" (func $wade.emscripten_glCompileShader (type $t10)))
  (import "env" "_llvm_log2_f32" (func $wade._llvm_log2_f32 (type $t7)))
  (import "env" "invoke_iiiiffi" (func $wade.invoke_iiiiffi (type $t13)))
  (import "env" "enlargeMemory" (func $env.enlargeMemory (type $t2)))
  (import "env" "_alSourcei" (func $wade._alSourcei (type $t13)))
  (import "env" "Oa" (func $wade.Oa (type $t4)))
  (import "env" "eglWaitGL" (func $wade.eglWaitGL (type $t1)))
  (import "env" "_61be69ba" (func $wade._61be69ba (type $t8)))
  (import "env" "alcCloseDevice" (func $wade.alcCloseDevice (type $t5)))
  (import "env" "invoke_fiji" (func $wade.invoke_fiji (type $t13)))
  (import "env" "_HideElement" (func $wade._HideElement (type $t12)))
  (import "env" "_emscripten_glIsEnabled" (func $wade._emscripten_glIsEnabled (type $t6)))
  (import "env" "getTotalMemory" (func $env.getTotalMemory (type $t2)))
  (import "env" "_XHRGet" (func $wade._XHRGet (type $t4)))
  (import "env" "_glGetActiveUniform" (func $wade._glGetActiveUniform (type $t6)))
  (import "env" "_emscripten_glSamplerParameteriv" (func $wade._emscripten_glSamplerParameteriv (type $t8)))
  (import "env" "_invoke_iiiiiii" (func $wade._invoke_iiiiiii (type $t12)))
  (import "env" "_JS_Sound_ResumeIfNeeded" (func $wade._JS_Sound_ResumeIfNeeded (type $t10)))
  (import "env" "abortOnCannotGrowMemory" (func $env.abortOnCannotGrowMemory (type $t2)))
  (import "env" "invoke_jiiiji" (func $wade.invoke_jiiiji (type $t2)))
  (import "env" "_emscripten_glBeginQuery" (func $wade._emscripten_glBeginQuery (type $t1)))
  (import "env" "free" (func $wade.free (type $t9)))
  (import "env" "_gmtime" (func $env._gmtime (type $t3)))
  (import "env" "invoke_viidddi" (func $wade.invoke_viidddi (type $t8)))
  (import "env" "N" (func $wade.N (type $t12)))
  (import "env" "_glBindRenderbuffer" (func $wade._glBindRenderbuffer (type $t8)))
  (import "env" "emscripten_set_mousedown_callback_on_thread" (func $wade.emscripten_set_mousedown_callback_on_thread (type $t8)))
  (import "env" "alSourcePause" (func $wade.alSourcePause (type $t7)))
  (import "env" "_IsAdblockEnabled" (func $wade._IsAdblockEnabled (type $t13)))
  (import "env" "_glScissor" (func $wade._glScissor (type $t13)))
  (import "env" "_isUsingPoki" (func $wade._isUsingPoki (type $t5)))
  (import "env" "_SetLocalStorage" (func $wade._SetLocalStorage (type $t12)))
  (import "env" "___setErrNo" (func $env.___setErrNo (type $t1)))
  (import "env" "Rc" (func $wade.Rc (type $t5)))
  (import "env" "pthread_setspecific" (func $wade.pthread_setspecific (type $t4)))
  (import "env" "time" (func $wade.time (type $t4)))
  (import "env" "_hiwire_throw_error" (func $wade._hiwire_throw_error (type $t7)))
  (import "env" "___syscall345" (func $wade.___syscall345 (type $t5)))
  (import "env" "___syscall75" (func $wade.___syscall75 (type $t4)))
  (import "env" "___atomic_fetch_and_8" (func $wade.___atomic_fetch_and_8 (type $t12)))
  (import "env" "_emscripten_memcpy_big" (func $env._emscripten_memcpy_big (type $t4)))
  (import "env" "_multi_intarg" (func $wade._multi_intarg (type $t9)))
  (import "env" "_glBlendFunc" (func $wade._glBlendFunc (type $t8)))
  (import "env" "emscripten_glValidateProgram" (func $wade.emscripten_glValidateProgram (type $t10)))
  (import "env" "_347092e7" (func $wade._347092e7 (type $t1)))
  (import "env" "_emscripten_glGenBuffers" (func $wade._emscripten_glGenBuffers (type $t9)))
  (import "env" "Bc" (func $wade.Bc (type $t2)))
  (import "env" "invoke_fiiii" (func $wade.invoke_fiiii (type $t1)))
  (import "env" "clock_gettime" (func $wade.clock_gettime (type $t9)))
  (import "env" "___syscall20" (func $env.___syscall20 (type $t5)))
  (import "env" "_1d677ada" (func $wade._1d677ada (type $t6)))
  (import "env" "nullFunc_vidi" (func $wade.nullFunc_vidi (type $t4)))
  (import "env" "__MNP_RedirectToAppStoreRatingPage" (func $wade.__MNP_RedirectToAppStoreRatingPage (type $t11)))
  (import "env" "_GoogleSignIn_GetEmail" (func $wade._GoogleSignIn_GetEmail (type $t2)))
  (import "env" "ed" (func $wade.ed (type $t13)))
  (import "env" "_mono_wasm_add_string_var" (func $wade._mono_wasm_add_string_var (type $t4)))
  (import "env" "__MNP_ShowMessage" (func $wade.__MNP_ShowMessage (type $t10)))
  (import "env" "invoke_vjji" (func $wade.invoke_vjji (type $t3)))
  (import "env" "_ftime" (func $env._ftime (type $t3)))
  (import "env" "_emscripten_glUniform3f" (func $wade._emscripten_glUniform3f (type $t7)))
  (import "env" "_GetArmorGamesAPIEnabled" (func $wade._GetArmorGamesAPIEnabled (type $t10)))
  (import "env" "emscripten_glCopyTexSubImage2D" (func $wade.emscripten_glCopyTexSubImage2D (type $t0)))
  (import "env" "___cxa_pure_virtual" (func $wade.___cxa_pure_virtual (type $t0)))
  (import "env" "_setSystem" (func $wade._setSystem (type $t12)))
  (import "env" "va" (func $wade.va (type $t11)))
  (import "env" "invoke_viffffffff" (func $wade.invoke_viffffffff (type $t7)))
  (import "env" "memory" (memory $env.memory 256 256))
  (import "env" "_hiwire_get_member_int" (func $wade._hiwire_get_member_int (type $t3)))
  (import "env" "_emscripten_glUnmapBuffer" (func $wade._emscripten_glUnmapBuffer (type $t6)))
  (import "env" "_6ba99a3a" (func $wade._6ba99a3a (type $t9)))
  (import "env" "__GameCenterLoadPlayers" (func $wade.__GameCenterLoadPlayers (type $t3)))
  (import "env" "table" (table $env.table 8 8 funcref))
  (import "env" "nullFunc_iijiiii" (func $wade.nullFunc_iijiiii (type $t9)))
  (import "env" "eglGetConfigAttrib" (func $wade.eglGetConfigAttrib (type $t12)))
  (import "env" "emscripten_glGetQueryObjectui64vEXT" (func $wade.emscripten_glGetQueryObjectui64vEXT (type $t11)))
  (import "env" "_glUniform3fv" (func $wade._glUniform3fv (type $t1)))
  (import "env" "_Poki_PreloadScriptsThenInit" (func $wade._Poki_PreloadScriptsThenInit (type $t1)))
  (import "env" "memoryBase" (global $env.memoryBase i32))
  (import "env" "emscripten_glStencilMaskSeparate" (func $wade.emscripten_glStencilMaskSeparate (type $t0)))
  (import "env" "_JS_Sound_Create_Channel" (func $wade._JS_Sound_Create_Channel (type $t12)))
  (import "env" "_64280efe" (func $wade._64280efe (type $t10)))
  (import "env" "jsCall_iiii" (func $wade.jsCall_iiii (type $t5)))
  (import "env" "invoke_viiiiiiiiiiiii" (func $wade.invoke_viiiiiiiiiiiii (type $t10)))
  (import "env" "_emscripten_glLineWidth" (func $wade._emscripten_glLineWidth (type $t7)))
  (import "env" "yc" (func $wade.yc (type $t3)))
  (import "env" "sc" (func $wade.sc (type $t13)))
  (import "env" "_glActiveTexture" (func $wade._glActiveTexture (type $t7)))
  (import "env" "tableBase" (global $env.tableBase i32))
  (import "env" "_glRenderbufferStorage" (func $wade._glRenderbufferStorage (type $t0)))
