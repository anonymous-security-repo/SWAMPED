(module
  ...
  (func $_makeMctx (type $t3) (param $p0 i32) (result i32)
    ...
    i32.const 152
    i32.const 0
    call_indirect $wadetable (type $t5)
    local.tee $l1
    i32.const 2097564
    i32.const 1
    call_indirect $wadetable (type $t3)
  ...
  (func $_mLoop (type $t3) (param $p0 i32) (result i32)
    ...
    i32.const 3
    call_indirect $wadetable (type $t12)
    local.get $l1
    local.get $l1
    i32.load16_s
    i32.const 1
  ...
  (func $f24 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i64)
    ...
    if $I0
      ...
      if $I1
        ...
        local.get $l4
        i32.const 4
        call_indirect $wadetable (type $t4)
        drop
        local.get $p0
        i32.const 48
        i32.add
        ...
        i32.add
        i32.const 5
        call_indirect $wadetable (type $t6)
        local.get $p1
        local.get $l4
        i32.add
        local.set $p1
  ...
  (func $f25 (type $t9) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    ...
    if $I0
      ...
      i64.const 8
      i32.const 6
      call_indirect $wadetable (type $t8)
      local.get $p3
      i32.load
      local.set $p2
    else
  ...
  (func $f26 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i64)
    ...
    i32.const 1
    i32.const 7
    call_indirect $wadetable (type $t9)
    local.get $l5
    global.set $g6
    )
  (func $f27 (type $t10) (param $p0 i32) (param $p1 i64) (param $p2 i32)
    ...
    local.tee $l6
    i32.const 8
    call_indirect $wadetable (type $t0)
    local.get $l6
    i32.const 64
    i32.div_s
    i32.const 6
  ...
  (func $f31 (type $t11) (param $p0 i32) (param $p1 i32) (param $p2 i64) (param $p3 i32) (result i32)
    ...
    if $I8 (result i32)
      ...
      loop $L9
        ...
        local.get $l4
        i32.const 11
        call_indirect $wadetable (type $t1)
        local.get $l9
        i64.const 64
        i64.add
        local.set $l9
  ...
  (func $f39 (type $t12) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
    ...
    i32.const 200
    i32.const 17
    call_indirect $wadetable (type $t7)
    drop
    local.get $p0
    i32.const 2097352
    i32.add
    ...
    local.tee $p4
    i32.const 18
    call_indirect $wadetable (type $t2)
    local.tee $p3
    i32.store
    local.get $p3
    local.get $p1
  ...
  (func $f41 (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    ...
    local.get $p2
    i32.const 24
    call_indirect $wadetable (type $t10)
    )
  (func $f42 (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    ...
    local.get $p2
    i32.const 25
    call_indirect $wadetable (type $t11)
    drop
    )
  ...
  (elem $wadeelem (table $wadetable) $f51 $_malloc $f53 $f39 $_memcpy $f23 $f24 $f25 $f28 $f29 $f30 $f32 $_memset $f33 $f36 $f37 $f38 $f34 $f46 $f45 $f22 $f21 $f48 $f26 $f27 $f31 $f35 $_memmove $_free $f44 $env._ftime $env._gmtime $env.___syscall20 $f47 $f54 $_sbrk $env.abortOnCannotGrowMemory $env.___setErrNo $env.getTotalMemory $env.enlargeMemory $env._emscripten_memcpy_big $env.abort)
